...
const baseClassName = 'w-fit h-fit rounded-md shadow-md bg-white p-4 flex flex-col gap-6'
...
export function Card({title,size = 'medium', elevation= '1', children, ...otherProps}: CardProps) {
	return (
